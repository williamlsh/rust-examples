...
interface ServerInit {
    action: 'Init';
    dataConsumerTransportOptions: TransportOptions;
    dataProducerTransportOptions: TransportOptions;
			...
			switch (decodedMessage.action)
			{
				case 'Init': {
					...
					producerTransport = device.createSendTransport(
						decodedMessage.dataProducerTransportOptions
					);
					...
					consumerTransport = device.createRecvTransport(
						decodedMessage.dataConsumerTransportOptions
					);
